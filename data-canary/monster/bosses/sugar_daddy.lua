...
monster.attacks = {
	...
	{ name = "combat", interval = 20000, chance = 100, type = COMBAT_EARTHDAMAGE, radius = 4, effect = CONST_ME_GREEN_RINGS, target = false },
	{ name = "combat", interval = 10000, chance = 50, type = COMBAT_PHYSICALDAMAGE, minDamage = -500, maxDamage = -1000, effect = CONST_ME_CAKE, target = true },
}

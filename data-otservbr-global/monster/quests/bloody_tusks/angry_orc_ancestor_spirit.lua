...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 50, type = COMBAT_EARTHDAMAGE, effect = CONST_ME_GREEN_RINGS, target = true },
	{ name = "combat", interval = 4000, chance = 50, type = COMBAT_DEATHDAMAGE, effect = CONST_ME_GHOSTLY_SMILE, target = true },
}

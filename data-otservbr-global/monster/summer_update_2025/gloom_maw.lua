...
monster.loot = {
	...
	{ id = 35852, chance = 5590 }, -- new item
	{ name = "black pearl", chance = 3030 },
	{ id = 35853, chance = 2500 }, -- new item
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 12, type = COMBAT_DEATHDAMAGE, minDamage = -400, maxDamage = -500, length = 8, spread = 3, effect = CONST_ME_MORTAREA, target = false },

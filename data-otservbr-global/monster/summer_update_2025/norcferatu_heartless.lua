...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 8, type = COMBAT_ENERGYDAMAGE, minDamage = -100, maxDamage = -380, range = 7, effect = CONST_ME_ENERGYHIT, target = true },

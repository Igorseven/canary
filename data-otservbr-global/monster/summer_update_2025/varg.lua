...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 12, type = COMBAT_PHYSICALDAMAGE, minDamage = -230, maxDamage = -300, radius = 4, effect = CONST_ME_BLOOD_RAIN, target = false },
